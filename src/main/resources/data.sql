...
INSERT INTO _user(email, username, password, first_name, last_name, role, is_account_locked, picture) VALUES
    ...
    ('luka.zelovic@gmail.com', 'zela11', '2a$10$jicdgzoNyODhfwtEuXsYHelIRjzFZ5zIgqcXlHfoy9BROPAnWV2y2', 'Luka', 'Zelović', 0, false, 'assets/profile/guest2.jpg'), --dokma
    ('jana.zecevic@gmail.com', 'janci01', '$2a$10$NhX4GkvqpZTas4mZa9wxuevS.8VCi70t3tKXVekdD5/VCg2Hf.kAu', 'Jana', 'Zecević', 0, false, 'assets/profile/guest3.jpg'), --spale
    ('katarina.medic@gmail.com', 'meeeedic', '$2a$10$XxmC.cIEK6XvYUVOa2HvTOlMQlIk0J6oQYouW2iBdgob.sRv78W9C', 'Katarina', 'Medić', 0, false, 'assets/profile/guest4.jpg'), --nina
    ('nina.knezevic@gmail.com', 'bekana', 'password5', 'Nina', 'Knezević', 0, false, 'assets/profile/guest5.jpg'),
    ('jovan.brboric@gmail.com', 'cabacaba', 'password6', 'Jovan', 'Brborić', 0, false, 'assets/profile/guest6.jpg'),
    ('spasoje.brboric@gmail.com', 'cicko01', 'password7', 'Spasoje', 'Brborić', 0, false, 'assets/profile/guest7.jpg'),
    ('nikola.markovic@gmail.com', 'markan01', 'password8', 'Nikola', 'Marković', 0, false, 'assets/profile/guest8.jpg'),
    ('ryan.reynolds@gmail.com', 'deadpool', 'password9', 'Darko', 'Babijanović', 0, false, 'assets/profile/guest9.jpg'),
    ('hugh.jackman@gmail.com', 'wolverine', 'password10', 'Uros', 'Komlenić', 0, false, 'assets/profile/guest10.jpg'),
    ...
    ('julia.roberts@gmail.com', 'julia', 'password13', 'Jovan', 'Kokotović', 0, false, 'assets/profile/guest13.jpg'),
...
-- Pozitivan komentar od gosta
INSERT INTO comment (user_id, exhibition_id, text, parent_comment_id, comment_date) VALUES
(5, 2, 'The level of detail in Hokusai’s works is absolutely mesmerizing. I’ve been fascinated by "The Great Wave" for years, and seeing it in person was a dream come true! Kyōsai’s "Deer and Monkeys" was a beautiful contrast to Hokusai’s work, showcasing a different yet equally captivating style. Zanimljivo!', NULL, '2024-07-05'),
-- Anonimni komentar
...
INSERT INTO comment(user_id, exhibition_id, text, parent_comment_id, comment_date) VALUES
-- Pozitivni komentari
(1, 3, 'Neverovatno iskustvo! Fotografije su toliko snažne i emotivne da su me duboko dotakle. Posebno mi se svidela fotografija “Napalm Girl” - pravi simbol jednog mračnog perioda u istoriji. Veoma zanimljivo!', NULL, '2024-07-20'),
...
(9, 3, 'Za ljubitelje fotografije, ovo je obavezno! “Lunch Atop a Skyscraper” je bio fascinantan – stvarno se vidi koliko su radnici bili hrabri.', NULL, '2024-07-23'),

-- Organizacijska pitanja i odgovori
(10, 3, 'Da li će ova izložba biti ponovljena sledeće godine? Imam prijatelja koji bi ovo obožavao, ali nije mogao da dođe sada.', NULL, '2024-07-24'),
...
(NULL, 3, 'Da li će ova izložba biti dostupna online za one koji ne mogu prisustvovati lično? Voleo/la bih da ponovo pregledam neke od ovih dela nakon što izložba završi.', NULL, '2024-07-25'),
(23, 3, 'Trenutno istražujemo mogućnosti da ovu izložbu učinimo dostupnom na mreži. Pratite ažuriranja na našoj veb stranici. Hvala vam na interesovanju!', 26, '2024-07-29'),

-- Kreativna pitanja i odgovori
(13, 3, 'Da li su fotografije originalne ili su ovo reprodukcije? Zanimljivo je videti tako ikonične slike.', NULL, '2024-07-26'),
(27, 3, 'Većina prikazanih fotografija su visokokvalitetne reprodukcije, s obzirom da su originali previše osetljivi za čestu izloženost svetlu. Svaka fotografija je detaljno objašnjena uz odgovarajuće informacije.', 28, '2024-07-27'),
...
(5, 3, 'Izložba je solidna, ali sam očekivala više interaktivnih elemenata. Za mlade posetioce, samo gledanje fotografija možda nije dovoljno da ih privuče.', NULL, '2024-07-29'),
...
(7, 3, 'Da, to je i mene pogodilo. Toliko je realna i surova. Dorothea Lange je stvarno uspela da prikaže ljudsku patnju.', 32, '2024-07-31');
...
(23, 4, 'We’re currently exploring options for making this exhibition available online. Stay tuned for updates on our website. Thank you for your interest!', 37, '2024-08-18'),
...
(26, 4, 'Boudin was known for his plein air painting, where he painted outdoors to capture the natural light directly. His mastery of light and reflection, especially on water, was groundbreaking and had a significant influence on the Impressionist movement.', 39, '2024-08-20'),

-- Mild criticism
(2, 4, 'While the exhibition is visually stunning, I wish there was more information provided on each piece. Some deeper context about the time periods and techniques would have enhanced the experience.', NULL, '2024-08-21'),
(9, 4, 'Beautiful art, but the layout of the exhibition felt a bit crowded. It was hard to focus on individual pieces with so many people around. Sve u svemu, dosadno!', NULL, '2024-08-23'),

-- Follow-up discussion
(10, 4, 'I agree with the comment about the crowd. I visited on a weekend, and it was difficult to really enjoy each piece. Maybe they could consider timed entries?', 42, '2024-08-24'),
(23, 4, 'Thank you for your feedback! We are looking into ways to improve the visitor experience, including the possibility of timed entries during peak hours.', 42, '2024-08-25');
...
(27, 5, 'Friedrich was inspired by the Romantic ideal of the sublime, which emphasizes nature’s overwhelming power and beauty. This painting reflects the human experience of standing in awe of something far greater than oneself, an important theme in Romanticism.', 48, '2024-08-29'),
...
(23, 5, 'Yes, we are currently working on plans to bring this exhibition to several other major cities. We’ll update our website with more details soon!', 50, '2024-09-01'),

-- Criticism and follow-up comments
(8, 5, 'While I appreciate the theme, I felt that the exhibition was somewhat repetitive and boring - dosadno. Several pieces, though individually beautiful, seemed to convey similar ideas without much variation in technique.', NULL, '2024-09-02'),
(9, 5, 'I understand your point, but I think the repetition serves to highlight the central themes of Neoclassicism and Romanticism. The focus on grand ideals and deep emotion is reinforced through these similar techniques.', 52, '2024-09-03'),

-- Response to criticism
(27, 5, 'We appreciate your feedback! The exhibition was curated to provide a deep dive into how these movements used similar visual styles to convey vastly different emotional landscapes. I encourage you to revisit with this in mind, and perhaps you’ll discover new layers in each piece.', 54, '2024-09-04');

INSERT INTO comment(user_id, exhibition_id, text, parent_comment_id, comment_date) VALUES
-- Positive comments
(5, 6, 'Pajine slike su neverovatne! "Seoba Srba" je jedna od najimpresivnijih slika koje sam ikada video. Prikazuje ne samo istoriju, već i emocije naroda kroz svaki potez četkice. Ova izložba je pravo umetničko blago. Prosto veoma zanimljivo i poučno, preporuka za svakog ljubitelja umetnosti.', NULL, '2024-08-30'),
...
(26, 6, 'Slika je zasnovana na istorijskim činjenicama, ali Jovanović koristi umetničku slobodu kako bi naglasio emocije i značaj ovog događaja za srpski narod. Detalji su precizno istraženi, ali kompozicija i atmosfera su umetnički interpretirani.', 58, '2024-09-03'),

-- Organizational questions and responses
(2, 6, 'Da li će ova izložba biti ponovo prikazana negde u unutrašnjosti Srbije? Želim da je preporučim prijateljima koji nisu u Beogradu.', NULL, '2024-09-04'),
(22, 6, 'Planiramo da izložba obiđe nekoliko gradova širom Srbije tokom sledeće godine. Proverite našu veb stranicu za tačne datume i lokacije!', 60, '2024-09-05'),
...
(10, 6, 'Slažem se. Posebno kod "Borbe petlova" je osvetljenje bilo slabo, a to je jedna od najdinamičnijih slika. Voleo bih da su bolji uslovi da se uživa u njoj.', 62, '2024-09-07'),

-- Response to criticism
(26, 6, 'Hvala na povratnim informacijama! Radićemo na poboljšanju osvetljenja kako bi svi posetioci mogli u potpunosti da uživaju u izložbi. Vaše primedbe su nam veoma važne.', 62, '2024-09-08');
...
(5, 7, 'Izložba je odlično organizovana, svaki rad je lepo i zanimljivo predstavljen. Posebno me oduševila "Deca pod dudom", slika koja odiše mirom i srećom. Predić je neverovatan u prikazu svakodnevnog života.', NULL, '2024-09-05'),
...
(27, 7, 'Predić je bio izuzetno posvećen autentičnosti svojih dela. Proučavao je istorijske izvore i konsultovao se sa stručnjacima kako bi verno prikazao događaje i osećanja vezana za njih. Ipak, njegov umetnički izražaj je jednako važan kao i istorijska preciznost.', 68, '2024-09-06'),
...
(23, 7, 'Trenutno planiramo da izložba bude postavljena u Novom Sadu krajem sledeće godine. Više informacija o datumu i mestu možete pronaći na našoj veb stranici!', 70, '2024-09-08'),
...
(12, 7, 'Slažem se, informacije o nekim delima nisu bile jasno vidljive. Bilo bi bolje kada bi bile postavljene bliže slikama, ili sa boljim osvetljenjem.', 72, '2024-09-10'),

-- Response to criticism
(27, 7, 'Hvala na povratnim informacijama! Radimo na unapređenju organizacije izložbi kako bi svi posetioci mogli da uživaju u umetničkim delima bez ometanja. Vaši komentari su nam veoma korisni.', 74, '2024-09-11');
...
(28, 8, 'Great question! Klimt used gold leaf to evoke a sense of otherworldliness and timeless beauty. The gold in "The Kiss" symbolizes both divine love and the eternal connection between the two figures. It’s also a nod to his fascination with Byzantine art, where gold was often used to convey the sacred and the precious.', 78, '2024-09-09'),

-- Organizational questions and responses
(2, 8, 'Is this exhibition going to be available online for virtual viewing? I would love to experience it but can’t visit in person.', NULL, '2024-09-10'),
(23, 8, 'We’re currently working on making parts of the exhibition available through a virtual tour! Please check back on our website in the coming weeks for updates.', 80, '2024-09-11'),

-- Criticism and follow-up comments
(19, 8, 'While the artwork is stunning, I felt that the lighting in the gallery was a bit too dim, especially near "Judith I". It was hard to fully appreciate the details. Dosadno posle dužeg vremena.', NULL, '2024-09-12'),
(20, 8, 'I agree, the lighting could be better. I had trouble seeing the intricate patterns on some of the paintings. Still, the exhibition overall is amazing, just a bit of a shame about the lighting.', 82, '2024-09-13'),

-- Response to criticism
(28, 8, 'Thank you for your feedback! We’re constantly working to improve the experience for our visitors and will take your comments about the lighting into consideration for future exhibitions.', 82, '2024-09-14');
...
(26, 9, 'Ova izložba će uključiti Šumanovićeva najpoznatija dela poput "Šid pod snegom" i "Pijana ladja", ali ćemo prikazati i neka manje poznata dela koja osvetljavaju druge aspekte njegovog stvaralaštva. Nadamo se da će posetioci uživati u raznolikosti prikazanih radova.', 85, '2024-10-11'),

(NULL, 9, 'Kada je planirano otvaranje izložbe? I da li će biti vođenih tura tokom trajanja?', NULL, '2024-10-12'),
(23, 9, 'Izložba će biti otvorena 15. oktobra 2024. godine i trajaće do 15. januara 2025. godine. Takođe ćemo organizovati vođene ture svakog vikenda. Detalje o vremenu tura možete naći na našem sajtu ili prilikom posete muzeju.', 87, '2024-10-13'),
...
(26, 9, 'Odlično pitanje! "Pijana ladja" je inspirisana pesmom "Le Bateau ivre" koju je napisao francuski pesnik Artur Rambo. Šumanović je bio fasciniran tom pesmom i njenim simbolima, što je uticalo na stvaranje slike. Ova slika simbolizuje životno putovanje, puno izazova i preokreta.', 89, '2024-10-15'),

-- Organizacijska pitanja
(15, 9, 'Da li će se ova izložba održavati i u nekim drugim gradovima nakon što završi u vašem muzeju?', NULL, '2024-10-16'),
(23, 9, 'Trenutno nemamo planove da izložbu premestimo u druge gradove, ali svakako postoji mogućnost da u budućnosti proširimo njen domet. Preporučujemo da nas pratite za eventualne najave.', 91, '2024-10-17'),

(NULL, 9, 'Postoji li mogućnost online prikaza dela za one koji nisu u mogućnosti da dođu na izložbu uživo?', NULL, '2024-10-18'),
(23, 9, 'Trenutno radimo na digitalizaciji nekih od najvažnijih dela i planiramo da omogućimo online prikaz izložbe u skorijoj budućnosti. Pratite naš sajt za više informacija.', 93, '2024-10-19');
...
(27, 10, 'Yes, we will be offering guided tours that focus on Kandinskys groundbreaking approach to abstract art, particularly his use of color to evoke emotions. You can sign up for the tours at the entrance or on our website.', 95, '2024-10-26'),
...
(27, 10, 'Yes, "Composition VIII" is one of the centerpiece works of this exhibition. It’s an incredible opportunity to see this masterpiece up close and experience Kandinskys powerful use of geometry and color in person.', 97, '2024-10-21'),
...
(23, 10, 'We are working on a virtual tour for this exhibition, which will allow you to experience some of the highlights online. Keep an eye on our website for more information.', 101, '2024-10-25'),

-- Practical information
(NULL, 10, 'Are tickets required in advance for this exhibition, or can we buy them at the door?', NULL, '2024-10-26'),
(23, 10, 'You can buy tickets at the door, but we recommend purchasing them in advance to guarantee your spot, especially on weekends when it can get busy.', 103, '2024-10-27');
...
(25, 11, 'Absolutely! Our curators have prepared detailed explanations and will provide insight into the cultural importance of the Ephebes in ancient Greek society, focusing on their role as symbols of beauty and athleticism.', 105, '2024-11-29'),
...
(25, 11, 'The sculptures in this exhibition are original pieces, carefully preserved to maintain their historical and artistic integrity. You’ll have the chance to see authentic ancient Greek sculptures up close.', 107, '2024-11-27'),
...
(23, 11, 'Yes, we have a special program for younger visitors, including interactive activities and a simplified guide to help children engage with the sculptures and the myths behind them. We think your son will love it!', 111, '2024-11-25'),

-- Logistical questions
(NULL, 11, 'Will there be any evening viewing times available for this exhibition?', NULL, '2024-11-23'),
(23, 11, 'Yes, we will be offering extended evening hours on Fridays and Saturdays to allow more visitors to enjoy the exhibition after work hours. Tickets for these time slots can be purchased online.', 113, '2024-11-24');
...
(26, 12, 'Yes, we will provide detailed historical context on the sculpture, including its religious significance during the medieval period and the craftsmanship behind its creation. Visitors will gain insight into its spiritual and artistic importance.', 115, '2025-01-06'),

(NULL, 12, 'Are the "Saint Peter" and "Saint Paul" sculptures part of a larger religious collection?', NULL, '2025-01-04'),
(26, 12, 'Good question! These sculptures were originally part of a larger ecclesiastical collection, most likely from a Venetian church. They are now displayed together to reflect their symbolic connection as pillars of the Christian faith.', 117, '2025-01-05'),
...
(26, 12, 'Indeed, the level of detail in medieval sculpture is astounding. Sculptors used rudimentary tools, but their skill and deep religious devotion allowed them to create works of incredible intricacy. We’ll be highlighting these techniques throughout the exhibition.', 119, '2025-01-07'),
...
(23, 12, 'Yes, we’ll offer both guided tours and audio guides. The guided tours will focus on the religious and cultural significance of each piece, helping you connect more deeply with the artwork.', 121, '2025-01-09'),

-- Logistical questions
(NULL, 12, 'Is photography allowed during the exhibition? I’d love to capture some details of the sculptures.', NULL, '2025-01-06'),
(23, 12, 'Unfortunately, photography is not permitted inside the exhibition to preserve the delicate condition of the sculptures. However, we will provide high-quality images and detailed descriptions in the exhibition catalog.', 123, '2025-01-07');
...
(23, 13, 'Yes, we’ll be hosting a workshop on Renaissance printmaking techniques as part of the exhibition! Visitors will get a hands-on experience in creating simple prints using traditional methods. The schedule for the workshops will be available on our website soon.', 129, '2025-01-08'),
...
(23, 13, 'Yes, we offer both audio guides and guided tours for this exhibition. The audio guide will walk you through the history of printmaking and the artists featured in the exhibition, providing additional context to enhance your visit.', 131, '2025-01-07'),
...
(28, 14, 'Great question! Klimt used gold leaf to evoke a sense of otherworldliness and timeless beauty. The gold in "The Kiss" symbolizes both divine love and the eternal connection between the two figures. It’s also a nod to his fascination with Byzantine art, where gold was often used to convey the sacred and the precious.', 138, '2021-09-09'),
...
(23, 14, 'We’re currently working on making parts of the exhibition available through a virtual tour! Please check back on our website in the coming weeks for updates.', 140, '2021-09-11'),
...
(20, 14, 'I agree, the lighting could be better. I had trouble seeing the intricate patterns on some of the paintings. Still, the exhibition overall is amazing, just a bit of a shame about the lighting.', 142, '2021-09-13'),

-- Response to criticism
(28, 14, 'Thank you for your feedback! We’re constantly working to improve the experience for our visitors and will take your comments about the lighting into consideration for future exhibitions.', 142, '2021-09-14');

INSERT INTO comment(user_id, exhibition_id, text, parent_comment_id, comment_date) VALUES
-- General questions about printmaking and history
(NULL, 15, 'How did Renaissance artists achieve such fine detail in their prints without modern tools?', NULL, '2022-01-10'),
(27, 15, 'Great question! Renaissance printmakers used intricate techniques like engraving and etching, requiring great skill and patience. They worked with sharp tools to carve designs into metal plates, which were then inked and pressed onto paper. The precision of their work is truly remarkable, even by today’s standards.', 145, '2022-01-11'),

(11, 15, 'Will we get to see the entire series of Ludovico Mattioli’s monthly prints, or just a few?', NULL, '2022-01-09'),
(27, 15, 'We’ll be displaying a selection of Mattioli’s monthly prints, including "February," "June," and "January." These pieces were chosen to showcase the range of his skill and the seasonal themes he explored. The full series will also be available in the exhibition catalog for those interested in further study.', 147, '2022-01-10'),

-- Practical and logistical questions
(14, 15, 'Will there be a workshop where we can learn about Renaissance printmaking techniques?', NULL, '2022-01-07'),
(23, 15, 'Yes, we’ll be hosting a workshop on Renaissance printmaking techniques as part of the exhibition! Visitors will get a hands-on experience in creating simple prints using traditional methods. The schedule for the workshops will be available on our website soon.', 149, '2022-01-08'),
...
(23, 15, 'Yes, we offer both audio guides and guided tours for this exhibition. The audio guide will walk you through the history of printmaking and the artists featured in the exhibition, providing additional context to enhance your visit.', 151, '2022-01-07'),
...
(23, 16, 'We’re currently exploring options for making this exhibition available online. Stay tuned for updates on our website. Thank you for your interest!', 158, '2022-06-18'),

-- Creative/artistic questions and answers
(NULL, 16, 'Can you tell me more about the techniques used by Boudin? His use of light is phenomenal.', NULL, '2022-06-19'),
(26, 16, 'Boudin was known for his plein air painting, where he painted outdoors to capture the natural light directly. His mastery of light and reflection, especially on water, was groundbreaking and had a significant influence on the Impressionist movement.', 160, '2022-06-20'),
...
-- Follow-up discussion
(10, 16, 'I agree with the comment about the crowd. I visited on a weekend, and it was difficult to really enjoy each piece. Maybe they could consider timed entries?', 163, '2022-06-24'),
(23, 16, 'Thank you for your feedback! We are looking into ways to improve the visitor experience, including the possibility of timed entries during peak hours.', 163, '2022-06-25');
...
INSERT INTO review(guest_id, exhibition_id, rating, review_date) VALUES
 ...
 (6, 1, 3, '2024-07-12'),  -- Recenzija od gosta sa ID 6
 (7, 1, 3, '2024-07-14'),  -- Recenzija od gosta sa ID 7
 (8, 1, 4, '2024-07-16'),  -- Recenzija od gosta sa ID 8
 (9, 1, 2, '2024-07-18'),  -- Recenzija od gosta sa ID 9
 (10, 1, 2, '2024-07-20'); -- Recenzija od gosta sa ID 10
...
INSERT INTO review(guest_id, exhibition_id, rating, review_date) VALUES
 ...
 (11, 3, 5, '2024-07-24'),  -- Recenzija od gosta sa ID 3
 ...
 (9, 3, 2, '2024-08-05'),  -- Recenzija od gosta sa ID 9
 (10, 3, 2, '2024-08-07'); -- Recenzija od gosta sa ID 10

INSERT INTO review(guest_id, exhibition_id, rating, review_date) VALUES
 (11, 4, 1, '2024-04-05'),  -- Recenzija od gosta sa ID 11
 (12, 4, 2, '2024-04-07'),  -- Recenzija od gosta sa ID 12
 (13, 4, 2, '2024-04-10'),  -- Recenzija od gosta sa ID 13
 (14, 4, 2, '2024-04-12'),  -- Recenzija od gosta sa ID 14
 (15, 4, 1, '2024-04-15'),  -- Recenzija od gosta sa ID 15
 (16, 4, 3, '2024-04-18'),  -- Recenzija od gosta sa ID 16
 (17, 4, 3, '2024-04-20');  -- Recenzija od gosta sa ID 17

INSERT INTO review(guest_id, exhibition_id, rating, review_date) VALUES
(18, 5, 1, '2024-08-25'),  -- Recenzija od gosta sa ID 18
(19, 5, 2, '2024-08-27'),  -- Recenzija od gosta sa ID 19
(20, 5, 1, '2024-08-30'),  -- Recenzija od gosta sa ID 20
(1, 5, 2, '2024-09-01'),   -- Recenzija od gosta sa ID 1
(2, 5, 2, '2024-09-03');   -- Recenzija od gosta sa ID 2

INSERT INTO review(guest_id, exhibition_id, rating, review_date) VALUES
(3, 6, 4, '2024-09-01'),  -- Recenzija od gosta sa ID 3
(4, 6, 5, '2024-09-03'),  -- Recenzija od gosta sa ID 4
(5, 6, 5, '2024-09-06'),  -- Recenzija od gosta sa ID 5
(6, 6, 5, '2024-09-08'),  -- Recenzija od gosta sa ID 6
(7, 6, 4, '2024-09-10');  -- Recenzija od gosta sa ID 7
...
INSERT INTO review(guest_id, exhibition_id, rating, review_date) VALUES
(13, 8, 2, '2024-09-10'),  -- Recenzija od gosta sa ID 13
(14, 8, 3, '2024-09-12'),  -- Recenzija od gosta sa ID 14
(15, 8, 1, '2024-09-15'),  -- Recenzija od gosta sa ID 15
(16, 8, 2, '2024-09-18'),  -- Recenzija od gosta sa ID 16
(17, 8, 2, '2024-09-20');  -- Recenzija od gosta sa ID 17
